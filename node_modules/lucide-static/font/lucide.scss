@font-face {font-family: "lucide";
  src: url('lucide.eot?t=1705420132549'); /* IE9*/
  src: url('lucide.eot?t=1705420132549#iefix') format('embedded-opentype'), /* IE6-IE8 */
  url("lucide.woff2?t=1705420132549") format("woff2"),
  url("lucide.woff?t=1705420132549") format("woff"),
  url('lucide.ttf?t=1705420132549') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+*/
  url('lucide.svg?t=1705420132549#lucide') format('svg'); /* iOS 4.1- */
}
...
.icon-helping-hand:before { content: "\e3b3"; }
